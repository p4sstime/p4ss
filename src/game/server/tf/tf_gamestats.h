...
public:
	...
	void Event_PlayerPFGoal( CTFPlayer *pPlayer );
	void Event_PlayerPFAssist( CTFPlayer *pPlayer );
	void Event_PlayerPFSave( CTFPlayer *pPlayer );
	void Event_PlayerPFIntercept( CTFPlayer *pPlayer );
