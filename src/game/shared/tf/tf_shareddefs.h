...
enum medigloves_charge_types
{
	MEDIGLOVES_CHARGE_INVALID = -1,
	MEDIGLOVES_CHARGE_BLAST = 0,
	MEDIGLOVES_CHARGE_JUMP,
	MEDIGLOVES_CHARGE_TELEPORT,
	MEDIGLOVES_CHARGE_GRAPPLE,

	MEDIGLOVES_NUM_CHARGE_TYPES,
};
