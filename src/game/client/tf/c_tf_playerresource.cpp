...
IMPLEMENT_CLIENTCLASS_DT( C_TF_PlayerResource, DT_TFPlayerResource, CTFPlayerResource )
	...
	RecvPropArray3( RECVINFO_ARRAY( m_iP4ssHandoffs ),   RecvPropInt( RECVINFO( m_iP4ssHandoffs[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iP4ssIntercepts ), RecvPropInt( RECVINFO( m_iP4ssIntercepts[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iP4ssPasses ),     RecvPropInt( RECVINFO( m_iP4ssPasses[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iP4ssSaves ),      RecvPropInt( RECVINFO( m_iP4ssSaves[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iP4ssGoals ),      RecvPropInt( RECVINFO( m_iP4ssGoals[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iP4ssSplashes ),   RecvPropInt( RECVINFO( m_iP4ssSplashes[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iP4ssSteals ),     RecvPropInt( RECVINFO( m_iP4ssSteals[0] ) ) ),
