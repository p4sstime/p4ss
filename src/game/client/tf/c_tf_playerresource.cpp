...
IMPLEMENT_CLIENTCLASS_DT( C_TF_PlayerResource, DT_TFPlayerResource, CTFPlayerResource )
	...
	RecvPropArray3( RECVINFO_ARRAY( m_iPFScores ), RecvPropInt( RECVINFO( m_iPFScores[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iPFAssists ), RecvPropInt( RECVINFO( m_iPFAssists[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iPFSaves ), RecvPropInt( RECVINFO( m_iPFSaves[0] ) ) ),
	RecvPropArray3( RECVINFO_ARRAY( m_iPFIntercepts ), RecvPropInt( RECVINFO( m_iPFIntercepts[0] ) ) ),
