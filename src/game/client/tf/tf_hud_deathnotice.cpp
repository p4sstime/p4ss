...
ConVar cl_hud_killstreak_display_time( "cl_hud_killstreak_display_time", "0", FCVAR_ARCHIVE, "How long a killstreak notice stays on the screen (in seconds).  Range is from 0 to 100."  );
